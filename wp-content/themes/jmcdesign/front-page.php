...
<div id="container">
	<div id="content">
	    ...
	    <?php $blurb = new WP_Query('category_name=front-page-blurb');?>
           <?php if( $blurb->have_posts() ): while( $blurb->have_posts() ): $blurb->the_post(); ?>
                         
						<?php
        	
        			   echo '<p id="front_blurb">';
        			    
        			   
        			   $post_excerpt = get_the_excerpt();
        			   echo  $post_excerpt;
        			   
        			   // Hi! I'm Jared, I'm a freelance web designer and developer.  I'm addicted to creating beautiful intuitive websites and web applications. A maniac for detail and believer in the power of simplicity.  Have a look around my site, I'd love to work with you. 
        			    
        			    echo '</p>';  
		
		   endwhile; endif; ?>				
	
		  <?php include 'info_windows.php' ?>
